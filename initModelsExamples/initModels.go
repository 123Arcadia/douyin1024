...
const (
	...
	User1_profile_description       = "我是秦始皇，现在马上给我打99999，封你为大将军!"
	User2_profile_description       = "绝绝子，跺跺脚，暴风吸入"
	User3_profile_description       = "君子六艺——典、绷、乐、孝、赢、麻"
	User4_profile_description       = "一眼顶真，鉴定为傻卵"
	User5_profile_description       = "不会吧不会吧bhb"
	User6_profile_description       = "你*没了，这一切值得吗"
)
...
var initialUsers = []models.User{
	{
		...
		FavoriteCount:   6,                          // 喜欢数
		Avatar:          User1_avatar_url,           // 用户头像
		BackgroundImage: User1_background_image_url, // 用户个人页顶部大图
		Signature:       User1_profile_description,  // 个人简介
	...
	},
	{
		...
		FavoriteCount:   7,                          // 喜欢数
		Avatar:          User2_avatar_url,           // 用户头像
		BackgroundImage: User2_background_image_url, // 用户个人页顶部大图
		Signature:       User2_profile_description,  // 个人简介
	...
	},
	{
		...
		FollowerCount:   3,                          // 粉丝总数
		FavoriteCount:   7,                          // 喜欢数
		Avatar:          User3_avatar_url,           // 用户头像
		BackgroundImage: User3_background_image_url, // 用户个人页顶部大图
		Signature:       User3_profile_description,  // 个人简介
	...
	},
	{
		...
		FavoriteCount:   6,                          // 喜欢数
		Avatar:          User4_avatar_url,           // 用户头像
		BackgroundImage: User4_background_image_url, // 用户个人页顶部大图
		Signature:       User4_profile_description,  // 个人简介
	...
	},
	{
		...
		FollowerCount:   3,                          // 粉丝总数
		FavoriteCount:   6,                          // 喜欢数
		Avatar:          User5_avatar_url,           // 用户头像
		BackgroundImage: User5_background_image_url, // 用户个人页顶部大图
		Signature:       User5_profile_description,  // 个人简介
	...
	},
	{
		...
		FollowerCount:   3,                          // 粉丝总数
		FavoriteCount:   7,                          // 喜欢数
		Avatar:          User6_avatar_url,           // 用户头像
		BackgroundImage: User6_background_image_url, // 用户个人页顶部大图
		Signature:       User6_profile_description,  // 个人简介
		TotalFavorited:  "4",                        // 获赞数量
		WorkCount:       1,                          // 作品数
	},
}
